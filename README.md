...
- `jenkins_get_build`: Get build details including result, causes, parameters, artifacts, changes, and optional typed coverage summaries from common coverage plugin endpoints.
