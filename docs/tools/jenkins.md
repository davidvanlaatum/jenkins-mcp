...
- `jenkins_get_build`: returns build metadata, causes, parameters, artifacts, changes, and typed Warnings NG summary data from the build-level `/warnings-ng/api/json` endpoint when available.
